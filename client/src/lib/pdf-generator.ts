...
export class PDFGenerator {
  static generateInvoicePDF(invoice: Invoice, customer: Customer): void {
    ...
    doc.text(`Discount: Rs.${parseFloat(invoice.discountAmount).toFixed(2)}`, totalsX, finalY + 7);
    doc.text(`Tax: Rs.${parseFloat(invoice.taxAmount).toFixed(2)}`, totalsX, finalY + 14);
        ...
        <body>
          ...
          <div class="totals">
            <table>
              <tr>
                <td>Subtotal:</td>
                <td class="text-right">Rs.${parseFloat(invoice.subtotal).toFixed(2)}</td>
              </tr>
              <tr>
                <td>Discount:</td>
                <td class="text-right">Rs.${parseFloat(invoice.discountAmount).toFixed(2)}</td>
              </tr>
              <tr>
                <td>Tax:</td>
                <td class="text-right">Rs.${parseFloat(invoice.taxAmount).toFixed(2)}</td>
              </tr>
              <tr class="total-row">
                <td>Total:</td>
                <td class="text-right">Rs.${parseFloat(invoice.total).toFixed(2)}</td>
              </tr>
            </table>
          </div>
